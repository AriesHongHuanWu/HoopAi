...
# scheme [ball, rim, ball_in_basket, person], trains YOLO11s (PRECISE variant, 3 datasets), exports TFLite.
...
def main():
    ...
    m = YOLO("yolo11s.pt")
    m.train(data=f"{WORK}/data.yaml", epochs=120, imgsz=640, batch=16,
